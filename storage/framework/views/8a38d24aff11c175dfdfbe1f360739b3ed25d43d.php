        ...
        <div class="container">
            ...
            <div class="col-xs-12 col-sm-6 no-padding">
                <div class="clearfix payment-methods">
                    <ul>
                        <li><img src="<?php echo e(asset('assets/font_end/')); ?>/images/payments/1.png" alt=""></li>
                        <li><img src="<?php echo e(asset('assets/font_end/')); ?>/images/payments/2.png" alt=""></li>
                        <li><img src="<?php echo e(asset('assets/font_end/')); ?>/images/payments/3.png" alt=""></li>
                        <li><img src="<?php echo e(asset('assets/font_end/')); ?>/images/payments/4.png" alt=""></li>
                        <li><img src="<?php echo e(asset('assets/font_end/')); ?>/images/payments/5.png" alt=""></li>
                    </ul>
                </div>
            </div>
        </div>
...
<script>
    $(document).on('click','.add_to_cart',function () {
        ...
        $.ajax({
            type:"GET",
            url:"<?php echo e(url('add-to-cart')); ?>?product_id="+product_id+"&picture="+picture,
            success:function(data)
            {
