...
<section class="section featured-product wow fadeInUp">
    <h3 class="section-title"><a href="<?php echo e(url('/')); ?>/category/<?php echo e($category->category_name); ?>"><?php echo e($category->category_title); ?></a></h3>
            ...
            <div class="products">
                ...
                <div class="product">
                    ...
                    <div class="product-info text-left">
                        ...
                        <h3 class="name">Product Code : <?php echo e($product->sku); ?></h3>
