        ...
        <div class="col-sm-offset-0 col-md-12">
                           ...
                           <table class="table table-striped table-bordered">
                             ...
                             //  $item_count = $item_count + $item['qty'];
                               ...
                               ?>
                                                                              ...
                                                                              <tr>
                              													<td><a  target="_blank" href="<?php echo e(url('product')); ?>/<?php echo e($name); ?>"><?php $name=(isset($item['name']) ? $item['name'] : null);echo $name; ?></a></td>
                              														<td><?php echo e($sku); ?></td>
                              														<td class="image text-center">
                              														<img src="<?php echo $featured_image ?>" height="30" width="30">
                              													</td>
                                                                          <td >
                              														<input type="number" name="products[items][<?php echo $order_id ?>][qty]" class="form-control item_qty" value="<?php echo  $quantity= isset($item['qty']) ? $item['qty'] : null;  ?>" data-item-id="<?php echo $product_id ?>" style="width:70px;">
                               													</td>
          ...
          <input type="text"   name="products[items][<?=$product_id?>][subtotal]"    value="<?=$item['subtotal']?>"/>
                           ...
                           <span class="bold">৳ <span
                                       id="delivery_cost"><?= $order->shipping_charge . '.00'; ?>
                               </span>
                               </span>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Xampp\htdocs\first_laravel_ecomerce\resources\views/admin/order/edit.blade.php ENDPATH**/ ?>