                ...
                <div class="card-header">
                    ...
                    <div class="row ">
                        ...
                        <div class="col-md-3 col-lg-3  col-12  home_print_mobile_class" style="padding: 2px;">
                            <a href="" class="btn btn-info  d-print-none">
                    ...
                    <div class="cart-info">
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tr>
                                ...
                                <td class="text-right" style="width:50%">
                                    <span class="bold totalamout"><b> <?= ($total) ?>  </b></span>
                                </td>
                            </tr>
                            <tr>
                                <td style="75%">
                                ...
                                <td class="text-right" style="width:50%">
                                                    <span
                                                        class="bold totalamout"><b><?= ($order->shipping_charge) ?> </b></span>
                                </td>
                            </tr>
                            <tr>
                                <td style="75%">
                                ...
                                <td class="text-right" style="width:50%">
                                                    <span
                                                        class="bold totalamout"><b><?= ($order->order_total) ?> </b></span>
                                </td>
                            </tr>
                            </tbody>
                        </table>
