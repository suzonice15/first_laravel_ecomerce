...
<div class="wrapper">
    ...
    <header class="main-header">
        <!-- Logo -->
        <a href="{{ asset('assets/adminfile')}}/index2.html" class="logo">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    <li><!-- start message -->
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="{{ asset('assets/adminfile')}}/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                                Support Team
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="{{ asset('assets/adminfile')}}/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
